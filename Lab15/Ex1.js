...
// this sets a cookie with my name
app.get('/set_cookie', (request, response) => {
    let my_name = "Alex";
    response.cookie("My new name is ", my_name, {maxAge: 5000000}).send("Cookie sent");
});

app.get("/use_cookie", (request, response) => {
    let my_cookie = request.cookies["My new name is"];
